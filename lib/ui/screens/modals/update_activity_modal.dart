...
// UPDATE ACTIVITY MODAL — mirrors the web modal behaviors and fields.
// Note: this modal *does not* call the network directly; the Dashboard passes
// onSubmit & onDelete that call the API and refresh.



// UPDATE ACTIVITY MODAL — mirrors the web modal fields.
// This modal emits an updated Activity; the Dashboard does the PUT/DELETE.


// UPDATE ACTIVITY MODAL — emits updated Activity; Dashboard does PUT/DELETE.
// Verbose debug logging included.
