...
/// Tiny widget that listens to UserSession.avatarUrl and shows it.
/// If null/empty or the URL fails, it falls back to the provided asset.
class ProfileAvatar extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    ...
    final url = session.avatarUrl; // changes whenever profile updates
